...
The component-based app also includes Prometheus, Grafana, ServiceMonitor
resources, Grafana dashboards, and persistent storage for Prometheus and
Grafana. See [components/README.md](./components/README.md) for deployment,
Grafana access, metrics verification, and storage details.
